...
// cmdJournald runs a minimal journald-compatible daemon for the POSIX backend.
...
func cmdJournald() {
	...
	fmt.Fprintf(os.Stderr, "swash journald: listening on %s\n", daemon.SocketPath())
	fmt.Fprintf(os.Stderr, "swash journald: writing to %s\n", daemon.JournalPath())
