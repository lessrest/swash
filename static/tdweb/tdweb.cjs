;(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else if (typeof exports === "object") exports["tdweb"] = factory()
  else root["tdweb"] = factory()
})(this, function () {
    ...
    /******/ [
      ...
      /***/ function (module, exports, __webpack_require__) {
        module.exports = function () {
          return new Worker(
            __webpack_require__.p + "6c401ab23349ce7bcf14.worker.js",
          )
        }
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        function fillOptionsWithDefaults(options) {
          ...
          if (typeof options.webWorkerSupport === "undefined")
            options.webWorkerSupport = true // indexed-db

          if (!options.idb) options.idb = {} //  after this time the messages get deleted

          if (!options.idb.ttl) options.idb.ttl = 1000 * 45
          if (!options.idb.fallbackInterval)
            options.idb.fallbackInterval = 150 // localstorage

          if (!options.localstorage) options.localstorage = {}
          if (!options.localstorage.removeTimeout)
            options.localstorage.removeTimeout = 1000 * 60 // node
        ...
        function readNewMessages(state) {
          ...
          return getMessagesHigherThen(state.db, state.lastCursorId).then(
        ...
        function _post(broadcastChannel, type, msg) {
          ...
          var awaitPrepare = broadcastChannel._prepP
        ...
        var src_TdClient =
          ...
          (function () {
            ...
            function TdClient(options) {
              ...
              this.fileManager = new src_FileManager(
            ...
            createClass_default()(TdClient, [
              ...
              },
              {
                ...
                value: function doSend(query, isExternal) {
                  ...
                  if (query["@extra"]) {
                    query["@extra"] = {
                      "@old_extra": JSON.parse(
                        JSON.stringify(query["@extra"]),
                      ),
                  ...
                  var res = new Promise(function (resolve, reject) {
                    _this2.query_callbacks.set(_this2.query_id, [
                      resolve,
                      reject,
                    ])
                  })
                ...
                value: function externalPostMessage(query) {
                  ...
                  if (unsupportedMethods.includes(query["@type"])) {
                    this.onResponse({
                      ...
                      "code": 400,
                      "message":
                        "Method '" + query["@type"] + "' is not supported",
                    })
                    return
                  }
              ...
              },
              {
                ...
                value: function onResponse(response) {
                  ...
                  if ("@extra" in response) {
                    ...
                    var _this$query_callbacks =
                        this.query_callbacks.get(query_id),
                      _this$query_callbacks2 = slicedToArray_default()(
                        _this$query_callbacks,
                        2,
                      ),
              ...
              },
              {
                ...
                value: function registerFile(file) {
                  ...
                  if (file.arr) {
                    ...
                    if (info.arr) {
                      logger.warn(
                        "Got file.arr at least twice for the same file",
                      )
                      this.totalSize -= info.arr.length
                    }
