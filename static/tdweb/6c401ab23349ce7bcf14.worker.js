/******/ ;(function (modules) {
  // webpackBootstrap
  /******/ this["webpackChunktdweb"] = function webpackChunkCallback(
    chunkIds,
    moreModules,
  ) {
...
*/
    ...
    /***/ function (module, exports, __webpack_require__) {
      module.exports =
        __webpack_require__.p + "3dee0f934ca1a5946a253599e3e442c6.wasm"
    ...
    /***/ function (module, exports, __webpack_require__) {
      module.exports =
        __webpack_require__.p + "c3e89babe1c03ad20450fff04e577278.mem"
    ...
    /***/ function (module, __webpack_exports__, __webpack_require__) {
      ...
      function instantiateCachedURL(dbVersion, url, importObject) {
        ...
        function openDatabase() {
          return new Promise(function (resolve, reject) {
            ...
            request.onupgradeneeded = function (event) {
              ...
              console.log(
                "Creating version ".concat(event.newVersion, " wasm cache"),
              )
        ...
        function lookupInDatabase(db) {
          return new Promise(function (resolve, reject) {
            ...
            request.onerror = reject.bind(
              null,
              "Error getting wasm module ".concat(url),
            )

            request.onsuccess = function (event) {
              if (request.result) resolve(request.result)
              else
                reject("Module ".concat(url, " was not found in wasm cache"))
            }
          })
      ...
      var td_wasm_default =
        /*#__PURE__*/ __webpack_require__.n(release_td_wasm)

      // EXTERNAL MODULE: ./src/prebuilt/release/td_asmjs.js.mem
      var td_asmjs_js = __webpack_require__(7)
      var td_asmjs_js_default =
        /*#__PURE__*/ __webpack_require__.n(td_asmjs_js)

      // CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/eslint-loader!./src/worker.js

      var tdlibVersion = 6
      var localForageDrivers = [
        localforage_default.a.INDEXEDDB,
        localforage_default.a.LOCALSTORAGE,
        "memoryDriver",
      ]
      ...
      function _initLocalForage() {
        _initLocalForage = asyncToGenerator_default()(
          ...
          regenerator_default.a.mark(function _callee29() {
            var memoryDriver
            return regenerator_default.a.wrap(function _callee29$(
              _context29,
            ) {
              while (1) {
                          ...
                          regenerator_default.a.mark(function _callee27(key) {
                            return regenerator_default.a.wrap(
                              function _callee27$(_context27) {
                                while (1) {
                                  switch (
                                    (_context27.prev = _context27.next)
                                  ) {
                                    case 0:
                          ...
                          regenerator_default.a.mark(function _callee28(
                            ...
                            return regenerator_default.a.wrap(
                              function _callee28$(_context28) {
                                while (1) {
                                  switch (
                                    (_context28.prev = _context28.next)
                                  ) {
                                    case 0:
      ...
      function _loadTdlibWasm() {
        _loadTdlibWasm = asyncToGenerator_default()(
          ...
          regenerator_default.a.mark(function _callee30(onFS, wasmUrl) {
            ...
            return regenerator_default.a.wrap(function _callee30$(
              _context30,
            ) {
              while (1) {
                switch ((_context30.prev = _context30.next)) {
                  case 0:
                    ...
                    return __webpack_require__
                      .e(/* import() */ 1)
                      .then(__webpack_require__.t.bind(null, 20, 7))
                  ...
                  case 3:
                    ...
                    module = createTdwebModule({
                      ...
                      instantiateWasm: function instantiateWasm(
                        imports,
                        successCallback,
                      ) {
                        ...
                        instantiateAny(tdlibVersion, td_wasm, imports).then(
                          next,
                        )
                        return {}
                      },
      ...
      function _loadTdlibAsmjs() {
        _loadTdlibAsmjs = asyncToGenerator_default()(
          ...
          regenerator_default.a.mark(function _callee31(onFS) {
            ...
            return regenerator_default.a.wrap(function _callee31$(
              _context31,
            ) {
              while (1) {
                switch ((_context31.prev = _context31.next)) {
                  case 0:
                    ...
                    return __webpack_require__
                      .e(/* import() */ 2)
                      .then(__webpack_require__.t.bind(null, 21, 7))
      ...
      function _loadTdlib() {
        _loadTdlib = asyncToGenerator_default()(
          ...
          regenerator_default.a.mark(function _callee32(mode, onFS, wasmUrl) {
            var wasmSupported
            return regenerator_default.a.wrap(function _callee32$(
              _context32,
            ) {
              while (1) {
                switch ((_context32.prev = _context32.next)) {
                  case 0:
                      ...
                      try {
                        if (
                          (typeof WebAssembly === "undefined"
                            ? "undefined"
                            : typeof_default()(WebAssembly)) === "object" &&
                    ...
                    if (!wasmSupported) {
                      if (mode === "wasm") {
                        logger.error(
                          "WebAssembly is not supported, trying to use it anyway",
                        )
                      } else {
                        logger.warn(
                          "WebAssembly is not supported, trying to use asm.js",
                        )
                        mode = "asmjs"
                      }
                    }
                          ...
                          while (1) {
                            switch ((_context.prev = _context.next)) {
                              case 0:
                                ...
                                logger.debug(
                                  "InboundFileSystem::create::keys start",
                              ...
                              case 8:
                                keys = _context.sent
                                keys_time =
                                  (performance.now() - keys_start) / 1000
                                logger.debug(
                                  "InboundFileSystem::create::keys " +
                                    keys_time +
                                    " " +
                                    keys.length,
                                )
                          ...
                          while (1) {
                            switch ((_context4.prev = _context4.next)) {
                              ...
                              case 4:
                                logger.debug(
                                  "persist.finish " +
                                    (performance.now() - this.writeBegin) /
                                      1000,
                                )
                          ...
                          while (1) {
                            switch ((_context7.prev = _context7.next)) {
                              ...
                              case 19:
                                ...
                                logger.debug(
                                  "InboundFileSystem::create " + create_time,
                                )
                              ...
                              case 26:
                                ...
                                logger.error(
                                  "Failed to init Inbound FileSystem: ",
                                  _context7.t0,
                                )
                          ...
                          while (1) {
                            switch ((_context11.prev = _context11.next)) {
                              ...
                              case 16:
                                ...
                                _context11.t0 = regenerator_default.a.keys(
                                  root_dir.node.contents,
                                )
                              ...
                              case 29:
                                ...
                                create_time =
                                  (performance.now() - start) / 1000
                                logger.debug(
                                  "DbFileSystem::create " + create_time,
                                )
                          ...
                          while (1) {
                            switch ((_context14.prev = _context14.next)) {
                              ...
                              case 10:
                                ...
                                tdfs.outboundFileSystem =
                                  new worker_OutboundFileSystem(
                                    prefix + "/outboundfs",
                                    tdfs.FS,
                                  )
                                _context14.next = 15
          ...
          createClass_default()(TdClient, [
                        ...
                        while (1) {
                          switch ((_context15.prev = _context15.next)) {
                            ...
                            case 4:
                              ...
                              _context15.prev = 7
                              _context15.next = 10
                              return localforage_default.a.setDriver(
                                driverName,
                              )
                        ...
                        while (1) {
                          switch ((_context16.prev = _context16.next)) {
                            ...
                            case 2:
                              ...
                              tdfs_promise = worker_TdFileSystem.create(
                            ...
                            case 13:
                              ...
                              this.td_functions = {
                                ...
                                td_send: this.TdModule.cwrap(
                                  "td_emscripten_send",
                                  null,
                                  ["number", "string"],
                                ),
                                td_execute: this.TdModule.cwrap(
                                  "td_emscripten_execute",
                                  "string",
                                  ["string"],
                                ),
                                td_receive: this.TdModule.cwrap(
                                  "td_emscripten_receive",
                                  "string",
                                  [],
                                ),
                                td_set_verbosity: function td_set_verbosity(
                                  verbosity,
                                ) {
                                  _this3.td_functions.td_execute(
                                    JSON.stringify({
                            ...
                            case 33:
                              ...
                              this.td_functions.td_set_verbosity(
            ...
            },
            {
              ...
              value: function prepareQueryRecursive(query) {
                if (query["@type"] === "inputFileBlob") {
                  return {
                    "@type": "inputFileLocal",
                    "path": this.tdfs.outboundFileSystem.blobToPath(
                      query.data,
                      query.name,
                    ),
                  }
            ...
            },
            {
              ...
              value: function prepareQuery(query) {
                if (query["@type"] === "setTdlibParameters") {
                  query.parameters.database_directory =
                    this.tdfs.dbFileSystem.root
                  query.parameters.files_directory =
                    this.tdfs.inboundFileSystem.root
            ...
            },
            {
              ...
              value: function execute(query) {
                try {
                  var res = this.td_functions.td_execute(
                    JSON.stringify(query),
                  )
                ...
                try {
                  while (true) {
                    ...
                    if (
                      ...
                      response.authorization_state["@type"] ===
                      ...
                      function _callee20$(_context20) {
                        while (1) {
                          switch ((_context20.prev = _context20.next)) {
                            case 0:
                              _context20.next = 2
                              return this.tdfs.inboundFileSystem.persist(
                                pid,
                                file.local.path,
                                arr,
                              )
            ...
            },
            {
              ...
              value: function flushPendingQueries() {
                ...
                try {
                  for (
                    var _iterator = this.pendingQueries[Symbol.iterator](),
                      _step;
